...
public class ProductSegment_POF {
	...
	public static void checkOrderOfProductSegment(String strTCID, List<String> strTestData) throws Throwable {
		...
		if (element != null) {
			...
			List<String> listExpectedDataFromExcel = strTestData;
			...
			try {
				...
				ReportFactory.reporterOutput(strTCID,
						"Verify the product segments available in the product segments modal window ",
						strTestData.toString(),
